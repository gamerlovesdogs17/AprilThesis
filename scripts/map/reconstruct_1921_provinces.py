        ...
        rows.append(
            {
                ...
                "geographicValidFrom": geographic_valid_from(rule),
                "geographicValidUntil": geographic_valid_until(rule),
                "administrativePeriods": json.dumps(administrative_periods(rule), ensure_ascii=False),
