...
export function CreditsScreen() {
  ...
  return <main className={styles.page}><article className={styles.paperPanel}>
    ...
    <section className={styles.section}><h2>Design and assets</h2><p>An original browser strategy game. Strategic composites, interface graphics, patterns, and generated PCM audio are project-created. The Workers’ Opposition interface insignia is a modern game symbol, not a documented historical faction emblem. Geographic context is derived from public-domain Natural Earth data. Thirteen character portraits are locally stored public-domain or CC0 Wikimedia Commons files with individual provenance records; Medvedev and Myasnikov use labeled designed fallbacks. The congress scene is an original artistic reconstruction, not a historical photograph.</p></section>
