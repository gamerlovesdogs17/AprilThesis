    ...
    <main className={styles.page}>
      <section className={styles.paperPanel}>
        ...
        <section className={styles.factionOverview} aria-label="Workers' Opposition campaign overview">
          <div className={styles.factionSeal}><svg viewBox="0 0 72 72" role="img" aria-label="Original Workers' Opposition game symbol"><circle cx="36" cy="36" r="30"/><path d="M36 9V18M36 54V63M9 36H18M54 36H63M17 17L23 23M49 49L55 55M55 17L49 23M23 49L17 55"/><circle cx="36" cy="36" r="18"/><path d="M27 46V29L32 25V37L37 34V42L43 38V46Z"/></svg><small>Original game symbol</small></div>
